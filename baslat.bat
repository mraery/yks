@echo off
title YKSLingo - YKS Hazirlik Uygulamasi
echo ===================================================
echo       YKSLingo (Duolingo Tarzi YKS) Baslatiliyor
echo ===================================================
echo.
cd /d "C:\Users\roy\.gemini\antigravity\scratch\ykslingo"

echo 1. Yerel web sunucusu calistiriliyor...
start "YKSLingo Web Sunucusu" /min python -m http.server 8080 --directory build\web
